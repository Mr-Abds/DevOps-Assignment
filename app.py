...
<h1>عبدالله سالم بارفعه</h1>   
    ...
    <main>
        <section>
            <h2>مرحباً — عنّي</h2>
            <p>أنا [اسمك هنا]، مطور/ـة بايثون وأعمل على تطوير تطبيقات ويب باستخدام Flask. أحب كتابة كود نظيف، إنشاء APIs بسيطة، وربط واجهات أمامية بخلفية قوية.</p>
    ...
    <section id="contact" style="max-width:1000px;margin:2rem auto;padding:0 1rem;">
        <h3>تواصل معي</h3>
        <p>البريد الإلكتروني: name@example.com</p>
        <p>الهاتف: +00 000 000 000</p>
